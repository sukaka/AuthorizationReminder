...
describe('sec-impl rbac matrix', () => {
  ...
  it('should enforce role-based permissions', async () => {
    ...
    const auditorUploadResp = await request({
      base: apiBase,
      path: `/api/sec-impl/projects/${jobId}/attachments`,
      method: 'POST',
      token: auditorToken,
      body: {},
    });
    ...
    const auditorReworkResp = await request({
      base: apiBase,
      path: `/api/sec-impl/projects/${jobId}/rework`,
      method: 'POST',
      token: auditorToken,
      body: {
        target_stage: 'TRIAL',
    ...
    const auditorVerifyResp = await request({
      base: apiBase,
      path: '/api/sec-impl/audit/verify?limit=100',
      method: 'GET',
      token: auditorToken,
    });
