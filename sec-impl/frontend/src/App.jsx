      ...
      <main className="login-shell">
        <section className="login-card">
          <h1>
            ...
            <span className="brand-blue">安全产品实施记录系统</span>
          </h1>
    ...
    <div className="shell">
      <aside className="sidebar">
        ...
        <div className="menu">
          ...
          <button className={activeMenu === 'jobs' ? 'active' : ''} onClick={() => setActiveMenu('jobs')}>实施单列表</button>
          <button className={activeMenu === 'create' ? 'active' : ''} onClick={() => setActiveMenu('create')}>新建实施单</button>
