...
# The first routing slice is intentionally deterministic.  It keeps the
# visible entry point simple while making every decision explainable and easy
# to evaluate before a model-based router is introduced.
AUTO_ROUTE_RULES = (
