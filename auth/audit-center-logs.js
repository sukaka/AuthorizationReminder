...
const normalizeAuditRow = (system, row = {}) => ({
  ...
  user_role: firstNonEmpty(row.user_role, row.operator_role, row.actor_role),
  system,
  ...
  after_data: row.after_data ?? row.after ?? row.detail ?? row.detail_json ?? null,
