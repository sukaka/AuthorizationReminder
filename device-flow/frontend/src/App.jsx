      ...
      <main className="login-shell">
        <section className="login-card">
          ...
          <div className="toolbar">
            ...
            <button className="btn" onClick={() => (window.location.href = buildPortalSwitchUrl('device-flow'))}>
              切换其他系统
            </button>
          </div>
        </section>
    ...
    <div className="shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-actions">
          <button className="ghost" onClick={() => (window.location.href = buildPortalSwitchUrl('device-flow'))}>切换系统</button>
