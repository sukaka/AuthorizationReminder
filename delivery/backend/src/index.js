...
const AUDIT_SIGNING_KEY = String(process.env.AUDIT_SIGNING_KEY || process.env.JWT_SECRET || 'delivery-audit-signing-key');
...
app.get(
  ...
  asyncHandler(async (_req, res) => {
    res.json({ ok: true, service: 'delivery', time: new Date().toISOString() });
  })
);
